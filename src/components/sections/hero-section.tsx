          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-muted-foreground text-lg md:text-xl font-medium leading-relaxed">
                Gabung komunitas badminton paling hype. Dari newbie yang baru pegang raket sampai pro yang cari lawan sparring sepadan.
              </p>
            </div>
          ...
          <div className="relative mx-auto w-full max-w-[500px] lg:max-w-none">
            ...
            <div className="relative aspect-square overflow-hidden rounded-[2.5rem] bg-muted border-4 border-white shadow-2xl rotate-3 hover:rotate-0 transition-all duration-500 ease-in-out group">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl text-white">
                 <p className="font-bold text-lg">🔥 Trending Now</p>
                 <p className="text-sm text-white/80">Weekend Smash Fest - Slots Running Out!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex animate-marquee whitespace-nowrap">
            {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex items-center mx-4">
                    <span className="text-4xl font-black text-foreground/10 mx-4">MABAR</span>
                    <span className="text-4xl font-black text-primary mx-4">•</span>
                    <span className="text-4xl font-black text-foreground/10 mx-4">SPARRING</span>
                    <span className="text-4xl font-black text-primary mx-4">•</span>
                    <span className="text-4xl font-black text-foreground/10 mx-4">COACHING</span>
                    <span className="text-4xl font-black text-primary mx-4">•</span>
                    <span className="text-4xl font-black text-foreground/10 mx-4">TOURNAMENT</span>
                    <span className="text-4xl font-black text-primary mx-4">•</span>
                </div>
            ))}
        </div>
