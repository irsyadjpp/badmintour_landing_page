...
export default function CoachSidebar() {
    ...
    const navItems = [
        ...
        { href: "/coach/schedule", icon: CalendarCheck, label: "Jadwal Saya" },
        { href: "/coach/students", icon: Users, label: "Daftar Murid" },
        { href: "/coach/modules", icon: Dumbbell, label: "Modul Latihan" },
        { href: "/coach/finance", icon: DollarSign, label: "Pendapatan" },
    ...
    return (
        <>
            {/* DESKTOP SIDEBAR */}
            <aside className="hidden md:flex fixed top-1/2 -translate-y-1/2 left-6 z-50 flex-col items-center py-8 bg-[#151515]/90 backdrop-blur-xl border border-white/10 rounded-[2.5rem] shadow-2xl transition-all duration-300 hover:bg-[#151515] hover:border-[#ffbe00]/30 min-h-[600px]">
                <TooltipProvider delayDuration={0}>

                    {/* Brand Logo (Updated) */}
                    <div className="mb-8 relative w-12 h-12 p-2 bg-white/5 rounded-2xl border border-white/10 shadow-[0_0_15px_rgba(255,190,0,0.2)] group overflow-hidden">
                        ...
                        return (
                            <Link key={item.label} href={item.href} className="flex flex-col items-center gap-1">
                                <div className={cn(
                                    ...
                                    isActive ? "bg-[#ffbe00] text-black shadow-lg shadow-[#ffbe00]/30" : "text-gray-500"
                                )}>
