        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <h1 className="text-3xl font-black text-white flex items-center gap-3">
              <BarChart3 className="w-8 h-8 text-[#ffbe00]" /> LABA RUGI (P&L)
            </h1>
            <p className="text-gray-400 mt-1">Analisis kinerja keuangan dan profitabilitas real-time.</p>
          </div>
        </div>

        {/* SUMMARY CARDS */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="bg-[#151515] border-white/5 shadow-lg">
          ...
          <Card className="bg-[#151515] border-white/5 border-l-4 border-l-[#ffbe00] shadow-xl">
            <CardHeader className="pb-2">
