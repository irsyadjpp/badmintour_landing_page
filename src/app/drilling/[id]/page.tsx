...
async function getEventDetails(id: string) {
  try {
    ...
    const participants = validBookings.map(b => ({
      name: b.userName || b.name || "Unknown Baller",
...
export default async function DrillingDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white font-sans text-gray-900">
      ...
      {/* BACKGROUND ACCENTS (Red Theme) */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden hover:none z-0">
        <div className="absolute top-[10%] left-[50%] -translate-x-1/2 w-[80%] h-[60%] bg-[#ca1f3d]/5 blur-[120px] rounded-full mix-blend-multiply" />
      </div>
          ...
          <div className="mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <Link href="/drilling">
              <Button variant="ghost" size="sm" className="h-9 rounded-full px-4 text-gray-500 hover:text-black hover:bg-gray-100 border border-gray-200 shadow-sm transition-all md:hover:pr-5">
                <ArrowLeft className="w-4 h-4 mr-2" /> Kembali ke Jadwal Drilling
              </Button>
            </Link>
          </div>
            ...
            <div className="lg:col-span-2 space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <Badge className="bg-[#ca1f3d] text-white hover:bg-[#a61a32] border-0 px-3 py-1 text-xs font-black uppercase tracking-widest shadow-sm">
                    OFFICIAL DRILLING
                  </Badge>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8 pb-8 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-[#ca1f3d]">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-gray-900 uppercase">{event.skillLevel || "OPEN FOR ALL"}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50/50 rounded-3xl p-6 md:p-8 border border-gray-100">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-black text-gray-900 mb-1">Lokasi Latihan</h3>
              ...
              <div className="prose prose-gray max-w-none">
                ...
                <p className="text-gray-600 leading-relaxed font-medium">
                  {event.description || "Tingkatkan skill badmintonmu melalui program drilling intensif. Fokus pada teknik, stamina, dan strategi permainan. Dibimbing langsung oleh Coach berpengalaman."}
                </p>

                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div className="flex items-center gap-2 text-sm text-gray-500 font-medium">
                    <CheckCircle2 className="w-4 h-4 text-[#ca1f3d]" /> Professional Coach
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-500 font-medium">
                    <CheckCircle2 className="w-4 h-4 text-[#ca1f3d]" /> Structured Program
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-500 font-medium">
                    <CheckCircle2 className="w-4 h-4 text-[#ca1f3d]" /> Shuttlecock Included
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-500 font-medium">
                    <CheckCircle2 className="w-4 h-4 text-[#ca1f3d]" /> Evaluation Sesi
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-lg font-black text-gray-900 mb-6 flex items-center justify-between">
                  <span>Students <span className="text-gray-400 font-medium text-sm ml-2">({filled}/{total})</span></span>
                ...
                {event.participants && event.participants.length > 0 ? (
                  ...
                  <div className="p-8 text-center bg-gray-50 rounded-3xl border border-dashed border-gray-200">
                    <p className="text-gray-500 font-medium text-sm">Belum ada peserta. Amankan slotmu!</p>
                  </div>
                )}
              </div>
            ...
            <div className="relative z-20">
              <div className="sticky top-32 animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
                <div className="bg-white border border-gray-100 rounded-[2.5rem] p-6 lg:p-8 shadow-[0_20px_40px_rgba(0,0,0,0.08)] overflow-hidden relative">
                  {/* DECORATIVE BLUR */}
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#ca1f3d]/20 to-[#ffbe00]/20 blur-3xl rounded-full -mr-10 -mt-10 pointer-events-none"></div>

                  <div className="relative z-10">
                    <p className="text-xs font-black text-gray-400 uppercase tracking-widest mb-2 text-center">BIAYA SESI</p>
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="flex justify-between items-center text-sm pb-3 border-b border-gray-50">
                        ...
                        <span className="font-bold text-gray-900">{event.coachName || event.hostName || "Pro Coach"}</span>
                      </div>
                      <div className="flex justify-between items-center text-sm pb-3 border-b border-gray-50">
                      ...
                      <div className="flex justify-between items-center text-sm pb-3 border-b border-gray-50">
                        ...
                        <span className="font-bold text-gray-900">{event.duration || "2"} Jam</span>
                      </div>
                    </div>

                    <Link href={`/member/booking?id=${event.id}`}>
                      <Button className={cn(
                        ...
                        isFull
                          ...
                          : "bg-[#ca1f3d] text-white hover:bg-[#a61a32]"
                      )}>
                        {isFull ? "Full Booked" : "Book Class"}
                      </Button>
                    </Link>

                    <p className="text-[10px] text-gray-400 text-center mt-4 font-medium leading-relaxed">
                      *Wajib hadir 15 menit sebelum mulai. Pembatalan maks H-1.
                    </p>
                  </div>
                </div>
