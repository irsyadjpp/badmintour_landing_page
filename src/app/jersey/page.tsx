...
import QRCode from "react-qr-code"; // IMPORT INI
        ...
        <>
           <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center pointer-events-none">
                    ...
                    <div className="flex-1 p-6 md:p-12 lg:p-16 space-y-10 max-w-2xl mx-auto w-full pt-24 lg:pt-16">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-[#151515] p-5 rounded-[1.5rem] border border-white/10 space-y-4">
                                ...
                                <div className="text-[10px] text-gray-500 leading-tight pt-2 border-t border-white/5">*Sistem otomatis menyingkat nama sesuai standar BWF (Maks 12 Karakter). Pilih salah satu yang Anda sukai.</div>
                            </div>
            ...
            <div className={cn(
                ...
                <div className="bg-white p-4 rounded-2xl mb-6 shadow-[0_0_50px_rgba(255,255,255,0.2)]">
                     {isClaimed && orderId && (
                        <QRCode
                            size={180}
