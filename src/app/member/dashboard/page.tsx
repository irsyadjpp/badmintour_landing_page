...
import { Trophy, CalendarDays, Clock, MapPin, QrCode, ArrowRight, Ticket, Swords, Dumbbell, UserCog, Users, Medal, SearchX } from 'lucide-react';
...
export default function MemberDashboard() {
  ...
  // Ubah null untuk tes empty state, atau isi object untuk tes ada tiket
  const [activeTicket, setActiveTicket] = useState<any>(null); 

  useEffect(() => {
    // Simulasi Fetch Data
    const timer = setTimeout(() => {
        // Uncomment baris bawah untuk simulasi ada data
        // setActiveTicket({
        //     id: "MABAR-001",
  ...
  return (
    <div className="space-y-8 pb-20">
        ...
        {/* 3. ACTIVE TICKET SECTION (With Empty State Logic) */}
        <section>
